...
function ImageCarousel() {
  ...
  const images = [
    { src: '/images/featureCarousel/AWarriorsTouch.jpg', title: 'Title 1', description: 'Description for Image 1' },
    { src: '/images/featureCarousel/AWorthyGaze.jpg', title: 'Title 2', description: 'Description for Image 2' },
    { src: '/images/featureCarousel/CosmicVogue.jpg', title: 'Title 3', description: 'Description for Image 3' },
    { src: '/images/featureCarousel/Shimmer.jpg', title: 'Title 4', description: 'Description for Image 4' },
  ];
